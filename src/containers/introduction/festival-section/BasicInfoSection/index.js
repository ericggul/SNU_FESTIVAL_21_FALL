...
function BasicInfoSection({ isMobile }) {
  ...
  const festivalDescription = (
    ...
    <S.FestivalDescription>
      ...
      <TextReveal text="밝게 빛나는 환상을 그리는 관악의 밤." globalDelay={3000} />
      <TextReveal text="여러분들이란 빛으로 가득 채워질 서울대학교 풍산마당과" globalDelay={4000} />
      <TextReveal text="함께할 비대면 축제 ver.2 관악의밤! 기대하시라!" globalDelay={4000} />
    </S.FestivalDescription>
    // </Fade>
  );
