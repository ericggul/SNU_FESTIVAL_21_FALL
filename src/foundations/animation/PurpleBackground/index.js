...
export default function PurpleBackground({width, height}) {
  useEffect(() => {
    const wave = new App();
  }, []);
  ...
  return (
    <div
      id="CanvasWrapper"
      style={{ width: width, height: height, background: `#111734`, 
      zIndex: '-3', position: 'absolute', overflow: 'hidden', top: "-1.5rem" }}
    />
  );
}
  ...
  init() {
    ...
    for (let i = 0; i < this.totalWheels; i += 1) {
      this.wheels.push(new Wheel(
        ...
        { r: getRandom(17, 36), g: getRandom(18, 26), b: getRandom(40, 87) },
      ));
    }
  }
